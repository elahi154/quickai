   ...
   const blogCategories =['General','Technology','Business','Health','Lifestyle','Education','Travel','Food']
    ...
    const onSubmitHandler = async(e)=>{
      ...
      try {
        ...
        const prompt = `Generate a blog titles fpor the keyword ${input} in the category of ${selectedCategory}.`
        ...
        toast.error(error.message || 'An error occurred while generating the titles')
      }
      setLoading(false)
    }
  return (
